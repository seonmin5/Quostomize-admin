...
export async function CardInfo() {
    try {
        const response = await fetch(`/api/cards/creationPending/info`, {
            method: 'GET',
            credentials: 'include',
            cache: "no-store",
            headers: {
...
export async function CardInfoByFilter(setCardInfo, param, filterData) {
    ...
    try {
        const response = await fetch(`/api/cards/creationPending/filter?${param}`, {
            method: 'GET',
            credentials: 'include',
            cache: "no-store",
            headers: {
...
export async function CardInfoByKeyword(setCardInfo, param, filterData) {
    ...
    try {
        const response = await fetch(`/api/cards/creationPending/search?${param}`, {
            method: 'GET',
            credentials: 'include',
            cache: "no-store",
            headers: {
